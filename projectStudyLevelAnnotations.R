...
projects.annotations <- list(
  ...
  'syn8361748' = list(consortium = 'mHealth',
                      ...
                      deviceLocation = c('hand'),
                      diagnosis=  c('asthma'), 
                      reportedOutcome =c('demographics survey', 'disease history survey',
                                         'medication report', 'daily prompt survey',
                                         'EQ5D survey', 'medical history survey',
                                         'milestone survey', 'weekly prompt survey',
  ...
  'syn11269541' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('active' , 'passive', 'patient reported outcome'),
                       deviceType = c('handheld'),
                       sensorType = c('touchscreen', 'accelerometer', 'gyroscope', 'magnetometer'),
                       devicePlatform = c('iOS'), 
                       deviceLocation = c('hand' , 'pocket'),
                       diagnosis=  c('control'), 
                       reportedOutcome =c('physical activity', 'cardiovascular health'),
                       digitalAssessmentCategory= c('cardiovascular'),
                       digitalAssessmentDetails = c('PAR-Q', 'HealthKit data',
                                                    '6-min walk test', 'health questionnaire'),
