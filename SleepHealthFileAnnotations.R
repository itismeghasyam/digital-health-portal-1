...
tables.annotations = list(
  ...
  'syn22264428' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'), #passive?
                       diagnosis= c('control'),
                       # deviceType = c(''),
                       # sensorType = c(''),
                       # devicePlatform = c(''), 
  ...
  'syn22264326'= list(consortium = 'mHealth',
                      ...
                      # devicePlatform = c(''), 
                      # deviceLocation = c(''),
                      reportedOutcome = c('sleep report'), # sleep history?
                      # digitalAssessmentCategory= c(''),
                      # digitalAssessmentDetails = c(''),
                      dataType=c('surveyData'),
                      dataSubtype=c('raw'),
  ...
  'syn21963204'= list(consortium = 'mHealth',
                      ...
                      sensorType = c('accelerometer'), # pedometer, GPS?
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('step count'),
  ...
  'syn21963196'= list(consortium = 'mHealth',
                      ...
                      dataCollectionMethod= c('passive'), # also active? - can be measured
                      diagnosis= c('control'),
                      deviceType = c('handheld', 'wearable'),
                      sensorType = c('photosensor'),
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('hand', 'wrist'), # hand - phone, wrist - apple watch
  ...
  'syn21963195'= list(consortium = 'mHealth',
                      ...
                      diagnosis= c('control'),
                      deviceType = c('handheld', 'wearable'),
                      sensorType = c('accelerometer'), # pedometer?
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('flights climbed'),
                      digitalAssessmentCategory= c('physical activity'),
                      digitalAssessmentDetails = c('daily physical activity'),
                      dataType=c('sensor'),
                      dataSubtype=c('processed', 'metadata'),
  ...
  'syn21962791'= list(consortium = 'mHealth',
                      ...
                      diagnosis= c('control'),
                      deviceType = c('handheld', 'wearable'),
                      sensorType = c('pedometer' ), #'accelerometer', 'GPS' ?
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('distance'),
                      digitalAssessmentCategory= c('physical activity'),
                      digitalAssessmentDetails = c('daily physical activity'),
                      dataType=c('sensor'),
                      dataSubtype=c('processed', 'metadata'),
  ...
  'syn21962783'= list(consortium = 'mHealth',
                      ...
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('basal energy burned'), # calories burned / energy burned?
                      digitalAssessmentCategory= c('physical activity'),
                      digitalAssessmentDetails = c('daily physical activity'),
                      dataType=c('sensor'),
                      dataSubtype=c('processed', 'metadata'),
  ...
  'syn21962782'= list(consortium = 'mHealth',
                      ...
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('exercise time'),
                      digitalAssessmentCategory= c('physical activity'),
                      digitalAssessmentDetails = c('daily physical activity'),
                      dataType=c('sensor'),
                      dataSubtype=c('processed', 'metadata'),
  ...
  'syn21962781'= list(consortium = 'mHealth',
                      ...
                      devicePlatform = c('iOS'), 
                      deviceLocation = c('pocket', 'wrist'),
                      reportedOutcome = c('active energy burned'), # calories burned / energy burned?
                      digitalAssessmentCategory= c('physical activity'),
                      digitalAssessmentDetails = c('daily physical activity'),
                      dataType=c('sensor'),
                      dataSubtype=c('processed', 'metadata'),
