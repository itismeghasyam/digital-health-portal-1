...
tables.annotations = list(
  ...
  'syn16782071' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('PAR-Q survey'),
  ...
  'syn16782070' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('daily check-in report'),
                       dataType=c('surveyData'),
                       dataSubtype=c('raw', 'metadata'),
                       metadataType = c('individual'),
                       dhPortalIndex = 'TRUE',
  ...
  'syn16782068' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('risk factor survey'),
                       dataType=c('surveyData'),
                       dataSubtype=c('raw'),
                       dhPortalIndex = 'TRUE',
                       dataDescriptionLocation = 'syn11269541/wiki/485635',
  ...
  'syn16782066' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('well being survey', 'satisfaction', 
  ...
  'syn16782065' = list(consortium = 'mHealth',
                       ...
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('Heart/Stroke Risk Score', 'Heart age'),
                       dataType=c('surveyData'),
                       dataSubtype=c('raw', 'metadata'),
                       metadataType = c('individual'),
                       dhPortalIndex = 'TRUE',
