...
tables.annotations = list(
  ...
  'syn16782072' = list(consortium = 'mHealth',
                       ...
                       numberParticipants= as.integer(22717), 
  ...
  'syn16782071' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(23990), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782070' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(17622), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782069' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(23232), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
                       reportedOutcome = c('sleep report', 'physical activity'),
                       dataType=c('surveyData'),
                       dataSubtype=c('raw'),
                       dhPortalIndex = 'TRUE',
                       dataDescriptionLocation = 'syn11269541/wiki/485635',
  ...
  'syn16782068' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(13851), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782067' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(15531), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782066' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(14165), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782065' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(4759), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782064' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(3441), 
  ...
  'syn16782063' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(7565), 
                       dataCollectionMethod= c('patient reported outcome'),
                       diagnosis= c('control'), 
  ...
  'syn16782062' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(4920), 
  ...
  'syn16782061' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(626), 
                       dataCollectionMethod= c('passive', 'active'),
                       deviceType = c('handheld', 'wearable'),
                       sensorType = c('accelerometer', 'gyroscope'),
                       devicePlatform = c('iOS'), 
  ...
  'syn16782060' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(881), 
                       dataCollectionMethod= c('passive', 'active'),
                       deviceType = c('handheld', 'wearable'),
                       sensorType = c('accelerometer', 'gyroscope',
                                      'magnetometer', 'pedometer', 'gps'),
  ...
  'syn16782059' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(12558),  
  ...
  'syn16782058' = list(consortium = 'mHealth',
                       study = study,
                       studyOrProject = projectlink,
                       numberParticipants= as.integer(1077), 
                       dataCollectionMethod= c('active'),
                       deviceType = c('handheld'),
